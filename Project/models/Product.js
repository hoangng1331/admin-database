...
const productSchema = Schema(
  {
    ...
    variants: {
      type: [
        {
          colorId: { type: Schema.Types.ObjectId, ref: 'Color' ,required: false },
          sizes: { type: [{
                          sizeId:{ type: Schema.Types.ObjectId, ref: 'Size', required: false },
...
productSchema.virtual('stock').get(function() {
  return this.variants.reduce((total, color) => {
    return total + color.sizes.reduce((acc, size) => {
